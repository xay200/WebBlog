...
const EditBlog = () => {
    ...
    const formSchema = z.object({
        category: z.string().min(1, "Tên danh mục không được bỏ trống"),
        title: z.string().min(1, "Tiêu đề không được bỏ trống"),
        slug: z.string().min(1, "Slug không được bỏ trống"),
        blogContent: z.string().min(1, "Nội dung không được bỏ trống"),
    })
                ...
                <CardContent>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}  >
                            ...
                            <div className='mb-3'>
                                <span className='mb-2 block'>Hình ảnh đại diện</span>
